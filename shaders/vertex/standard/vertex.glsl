...
layout(location = 3) in vec3 tangent;// Provided by your new pipeline
layout(location = 4) in vec3 bitangent;// Provided by your new pipeline

out vec2 TexCoords;
out vec3 FragPos;
out vec3 Normal;
out mat3 TBN;// Pass TBN to fragment
