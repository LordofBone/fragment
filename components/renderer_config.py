    ...
    def _validate_config(self, config):
        ...
        if "particle_type" in config:
            ...
            if particle_type not in (
                    "points", "lines", "line_strip", "line_loop", "lines_adjacency", "line_strip_adjacency",
                    "triangles",
                    "triangle_strip", "triangle_fan", "triangles_adjacency", "triangle_strip_adjacency", "patches"):
                raise ValueError(
